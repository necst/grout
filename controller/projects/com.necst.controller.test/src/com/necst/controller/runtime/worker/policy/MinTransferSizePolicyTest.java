...
public class MinTransferSizePolicyTest {
    ...
    public void retrieveClient() {
        ...
        ControllerArray out = new ControllerArray(controllerExecutionContext, 100, Type.SINT32);
        ...
        args.add(new ComputationArgumentWithValue(new ComputationArgument(2, "OUT", Type.NFI_POINTER, ComputationArgument.Kind.POINTER_INOUT), new ControllerArray(controllerExecutionContext, 100, Type.SINT32)));
        ...
        MinTransferSizePolicy minTransferSizePolicy = new MinTransferSizePolicy(controllerExecutionContext.workersManager);

        AbstractWorker selectedWorker = minTransferSizePolicy.retrieveClient(vertex);
